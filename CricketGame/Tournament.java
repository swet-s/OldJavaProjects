    ...
    public static void tour(int o, double sec) {
        ...
        for (int m = 0; ; m++) {
            ...
            if (nt < 6) {
                ...
                String cha = "";
                if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                    cha = nta[0];
                else if (Cricket.s1() > Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() < Cricket.s2() && Cricket.inn() == 1)
                    cha = nta[1];
                else {
                    System.out.print("\nSuperOver:-");
                    Cricket.match(1, sec, nta[0], nta[1]);
                    if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                        cha = nta[0];
                    else if (Cricket.s1() > Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() < Cricket.s2() && Cricket.inn() == 1)
                        cha = nta[1];
                ...
                if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                    ...
                    Cricket.match(1, sec, nta[0], nta[3]);
                    if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                        cha1 = nta[0];
                    else if (Cricket.s1() > Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() < Cricket.s2() && Cricket.inn() == 1)
                        cha1 = nta[3];
                    else {
                        System.out.print("PowerOver:-");
                        Cricket.match(1, sec, nta[0], nta[3]);
                        if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                            cha1 = nta[0];
                        else if (Cricket.s1() > Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() < Cricket.s2() && Cricket.inn() == 1)
                ...
                if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                    ...
                    System.out.print("SuperOver:-");
                    Cricket.match(1, sec, nta[1], nta[2]);
                    if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                        cha2 = nta[1];
                    else if (Cricket.s1() > Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() < Cricket.s2() && Cricket.inn() == 1)
                        cha2 = nta[2];
                ...
                if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                    ...
                    System.out.print("SuperOver:-");
                    Cricket.match(1, sec, nta[2], nta[3]);
                    if (Cricket.s1() < Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() > Cricket.s2() && Cricket.inn() == 1)
                        cha2 = nta[2];
                    else if (Cricket.s1() > Cricket.s2() && Cricket.inn() == 2 || Cricket.s1() < Cricket.s2() && Cricket.inn() == 1)
                        cha2 = nta[3];
